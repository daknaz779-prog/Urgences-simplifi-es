...
export default function Courses() {
  ...
  return (
    <div dir="ltr" className="bg-slate-50 dark:bg-slate-950 min-h-screen py-16 lg:py-24 transition-colors font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-200 dark:border-slate-800 mb-24 transition-colors">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border-2 border-orange-500 relative transition-colors">
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-10 lg:p-14 flex flex-col justify-between order-2 lg:order-1">
              ...
              <div className="bg-orange-50 dark:bg-orange-950/30 p-8 rounded-2xl border border-orange-200 dark:border-orange-900/50">
                <div className="flex items-end gap-4 mb-6">
                  <span className="text-4xl font-extrabold text-slate-900 dark:text-white">
                    3 000 DA
                  </span>
        ...
        {/* Bundle Course */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border-4 border-[#4c2882] relative mt-24 transition-colors">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-[#4c2882] text-white px-8 py-2 rounded-b-2xl font-bold text-sm z-20 shadow-md uppercase tracking-wider">
            Offre Spéciale
          </div>
          <div className="grid lg:grid-cols-2">
            <div className="p-10 lg:p-14 bg-gradient-to-br from-[#4c2882] to-purple-900 text-white relative">
            ...
            <div className="p-10 lg:p-14 flex flex-col justify-between">
              ...
              <div className="bg-purple-50 dark:bg-purple-950/30 p-8 rounded-2xl border border-purple-200 dark:border-purple-900/50">
                <div className="flex items-end gap-4 mb-6">
                  <span className="text-5xl font-extrabold text-[#4c2882] dark:text-purple-400">
                    5 000 DA
                  </span>
